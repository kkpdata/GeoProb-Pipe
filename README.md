...
| -- | -- | -- | -- | -- |
| could | middel | Uitvoeren van system calculations ombouwen naar Threads. | /calculations/system_calculations/piping_moria/build_and_run.py | 28 | 
...
| could | klein | Bespreken of we de physical values willen afronden? Af wellicht afrondden in de export. | /results/df_alphas_influence_factors_and_physical_values.py | 117 | 
...
| should | klein | D zit ook in kD_wvp. Dat is dubbelop. | /calculations/system_calculations/piping_system/limit_state_functions.py | 7 | 
