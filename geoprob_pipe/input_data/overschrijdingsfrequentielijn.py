# TODO: Naam aangepast naar OverschrijdingsfrequentielijnOutPhased om op andere plekken warnings en errors te
#  veroorzaken, mocht deze nog gebruikt worden. Hij is namelijk wellicht overbodig.
...
# import os
#
# class OverschrijdingsfrequentielijnOutPhased:
...
#
#
# class OverschrijdingsfrequentielijnCollection(BaseCollection[OverschrijdingsfrequentielijnOutPhased]):
#
...
#             self.add(hydra_locatie_id, OverschrijdingsfrequentielijnOutPhased(self.path_hrd, hydra_locatie_id))
#
