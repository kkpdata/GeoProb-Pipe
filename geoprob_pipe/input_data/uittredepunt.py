# TODO: Object nu overbodig met nieuwe input form?
...
# from geoprob_pipe.input_data.utils import generate_parameter_dict_for_variable, strip_suffix_from_list_parameter_names
#
#
# class Uittredepunt:
#
...
#         self.df = pd.read_excel(workspace.path_input_excel, sheet_name="Uittredepunten").rename(
