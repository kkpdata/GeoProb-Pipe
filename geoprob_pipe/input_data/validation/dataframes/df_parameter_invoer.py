...
FAILURE_QUERIES: List[FailureQuery] = [
    ...
    # Kolom 'scope'
    FailureQuery(
        query="scope in ['traject', 'vak', 'uittredepunt']",
        msg="De scope moet 'traject', 'vak' of 'uittredepunt' zijn."),

    # Kolom 'scope_referentie'
    FailureQuery(
        query="scope in ['vak', 'uittredepunt'] and scope_referentie.isnull()",
        msg="De scope referentie moet worden gespecificeerd wanneer de scope 'vak' of 'uittredepunt' is."),
