...
class DeterministicSystemCalculation:
    ...
    def __init__(self, input_object: Union[SystemCalculation]):
    ...
    def _collect_deterministic_input(self, func: Callable) -> Dict[str, float]:
        ...
        for distribution in self.input_object.given_distributions:
    ...
    def _calculate_limit_states(self):
        ...
        for func in self.input_object.given_limit_states:
