from geoprob_pipe.calculations.system_calculations.piping_moria.dummy_input import DUMMY_INPUT as DUMMY_INPUT_MORIA
from geoprob_pipe.calculations.system_calculations.piping_wbi.dummy_input import DUMMY_INPUT as DUMMY_INPUT_WBI
