...
from geoprob_pipe.calculations.limit_states.piping_lm import limit_state_model4a as system_variable_setup
...
def calc_Z_h(
    ...
    return system_variable_setup(
        ...
        v=v, theta=theta, eta=eta, g=g, gamma_water=gamma_water,
    )[1]
