...
class PipingSystemReliabilityCalculation(ParallelSystemReliabilityCalculation):
    ...
    def __init__(
        ...
        super().__init__(
            system_variable_distributions=system_variable_distributions,
            project_settings=project_settings, system_variable_correlations=system_variable_correlations)
