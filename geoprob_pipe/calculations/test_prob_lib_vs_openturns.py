...
def test_simple_dummy_reliability_calculation():
    ...
    assert round(SimpleBetaCalculation.prob_lib_beta(), 2) == expected_result
    assert round(SimpleBetaCalculation.openturns_beta(), 2) == expected_result
