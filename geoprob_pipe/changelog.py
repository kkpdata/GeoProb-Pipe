...
CHANGELOG = {
    ...
    "1.3.0":
        ...
        "uitgefaseerd als software requirement. Daardoor zijn beiden geen "
        "handmatige software requirements meer.",
    "1.2.0":
        "Implementatie van parallel rekenen en het inspecteren van een enkele "
        "berekening.",
    "1.1.0":
        "Implementatie van een eerste versie van het vergelijken van twee "
        "verschillende GeoProb-Pipe bestanden.",
    "1.0.0":
        "Implementatie GeoPackage als data (in- en uitvoer) bestand én "
        "implementatie van keuze in geohydrologische modellen.",
    "0.1.0":
        "Toevoegen features na interne gebruikerssessie WSRL 2025-08-11: (a) "
        "geopackage-export met resultaten, (b) Excel-export met physical "
        "values, alphas en invloedsfactoren, (c) Excel-export met resultaat "
        "per vak, (d) Excel-export met validatie berichten en (e) physical "
        "values in grafiek waterstandssfrequentielijn.",
    "0.0.15":
