...
CHANGELOG = {
    ...
    "0.1.0": "Toevoegen features na interne gebruikerssessie WSRL 2025-08-11: (a) geopackage-export met resultaten, "
             "(b) Excel-export met physical values, alphas en invloedsfactoren, (c) Excel-export met resultaat per "
             "vak, (d) Excel-export met validatie berichten en (e) physical values in grafiek "
             "waterstandssfrequentielijn.",
    "0.0.15": "Eerste vrijgave van wheel installatie-bestand.",
}
