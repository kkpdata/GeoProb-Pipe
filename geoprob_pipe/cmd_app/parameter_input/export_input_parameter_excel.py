...
def export_input_parameter_tables(app_settings: ApplicationSettings, tables: InputParameterTables):
    ...
    with importlib.resources.path(
            package='geoprob_pipe.cmd_app.parameter_input',
            resource='parameter_input_template.xlsx'
    ) as src_path:
    ...
    ws["A1"] = f"Geohydrologisch model '{INITIAL_INPUT_MAPPER[model_string]['label']}'"
    wb.save(dst_path)
