...
# def beta_scenarios_graph(geoprob_pipe: GeoProbPipe) -> go.Figure:
...
#                     customdata=df_for_graph.loc[mask_combi,
...
# def beta_uittredepunten_graph(geoprob_pipe: GeoProbPipe) -> go.Figure:
...
# def beta_vakken_graph(geoprob_pipe: GeoProbPipe,) -> go.Figure:
