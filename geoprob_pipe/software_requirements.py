...
class SoftwareRequirements:
    ...
    def __init__(self, app_settings: ApplicationSettings):
        self.validation_messages = ValidationMessages(
            about="Checking software requirements"
        )
        self.chrome_is_installed = (
            False  # self._check_chrome_is_installed(app_settings=app_settings)
        )
    ...
    def _check_chrome_is_installed(self, app_settings: ApplicationSettings) -> bool:
        try:
            ...
            file_path = os.path.join(
                ...
                f"{timestamp}_test_chrome_install_figure.png",
            )
            ...
            msg = (
                f"Google Chrome is not installed. This is an optional requirements used for exporting "
