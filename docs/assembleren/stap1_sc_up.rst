Stap 1: Ondergrondscenario en deelfaalmechanismen → beta per uittredepunt
================================================================================================
...
waar piping kan initiëren. In tegenstelling tot de klassieke BOI-benadering wordt geen enkele
doorsnede beschouwd, maar een groot aantal uittredepunten langs de waterkering.
Voor ieder uittredepunt worden de drie deelfaalmechanismen en meerdere ondergrondscenario’s beschouwd.
...
Elk rekenblok berekent één β‑waarde per uittredepunt per ondergrondscenario. 
Vervolgens worden de β‑waarden, gewogen naar de ondergrondscenariokans, samengevoegd 
tot één β‑waarde per uittredepunt. Als één scenarioberekening niet convergeert, dan 
convergeert het uittredepunt ook niet.
