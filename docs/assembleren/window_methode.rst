...
1. Voor alle berekende uittredepunten is de ligging bekend. Binnen de window wordt de maximale faalkans van alle uittredepunten in de window als vakkans genomen. 
Dit veronderstelt volledige afhankelijkheid binnen een window.
...
Daarom bepaalt GeoProb-Pipe voor verschillende groottes van het window de systeemkans zodat de gebruiker kan inschatten bij welke window-grootte de trajectkans benaderd wordt.