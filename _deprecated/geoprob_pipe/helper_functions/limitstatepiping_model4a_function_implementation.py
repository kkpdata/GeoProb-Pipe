...
#     D_cover = piping_functions.calc_D_cover(mv, top_zand)

#     # Calculate the critical potential
#     d_pot_c_u = piping_functions.calc_d_pot_c_u(D_cover, gamma_sat_cover, gamma_w)
...
def calc_Z_combin_piping(
    ...
    pot_model = model4a.Model4a(
        kD=k * D_wvp, D=D_wvp, c1=c_1, c3=c_3, L1=L1, L3=L3_geom, x_but=(0.0 - L2), x_bit=0.0
    )
    r_exit, r_but, r_bit = pot_model.respons(dist_BIT)
    pot_exit = geohydro_functions.calc_respons2pot(pp, r_exit, h)
